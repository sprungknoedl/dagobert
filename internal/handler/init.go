...
func Run(cmd *cobra.Command, args []string) {
	...
	// api keys
	secured.HandleFunc("GET /settings/api-keys/", h.APIKeyList)
	secured.HandleFunc("GET /settings/api-keys/{key}", h.APIKeyEdit)
	secured.HandleFunc("POST /settings/api-keys/{key}", h.APIKeySave)
	secured.HandleFunc("DELETE /settings/api-keys/{key}", h.APIKeyDelete)

	// settings (overview + report templates)
	secured.HandleFunc("GET /settings/", h.SettingsOverview)
	secured.HandleFunc("GET /settings/report-templates/", h.ReportTemplateList)
	secured.HandleFunc("GET /settings/report-templates/{id}", h.ReportTemplateEdit)
	secured.HandleFunc("POST /settings/report-templates/{id}", h.ReportTemplateSave)
	secured.HandleFunc("DELETE /settings/report-templates/{id}", h.ReportTemplateDelete)

	// settings (case templates)
	secured.HandleFunc("GET /settings/case-templates/", h.CaseTemplateList)
	secured.HandleFunc("GET /settings/case-templates/promote", h.CaseTemplatePromoteForm)
	secured.HandleFunc("POST /settings/case-templates/promote", h.CaseTemplatePromote)
	secured.HandleFunc("GET /settings/case-templates/{cid}", h.CaseTemplateEdit)
	secured.HandleFunc("POST /settings/case-templates/{cid}", h.CaseTemplateSave)
	secured.HandleFunc("DELETE /settings/case-templates/{cid}", h.CaseTemplateDelete)

	// settings (automation rules)
	secured.HandleFunc("GET /settings/automation-rules/", h.AutomationRuleList)
	secured.HandleFunc("GET /settings/automation-rules/{id}", h.AutomationRuleEdit)
	secured.HandleFunc("POST /settings/automation-rules/{id}", h.AutomationRuleSave)
	secured.HandleFunc("DELETE /settings/automation-rules/{id}", h.AutomationRuleDelete)

	// settings (valueLists)
	secured.HandleFunc("GET /settings/value-lists/", h.ValueListList)
	secured.HandleFunc("GET /settings/value-lists/{id}", h.ValueListEdit)
	secured.HandleFunc("POST /settings/value-lists/{id}", h.ValueListSave)
	secured.HandleFunc("DELETE /settings/value-lists/{id}", h.ValueListDelete)

	// settings (custom attributes)
	secured.HandleFunc("GET /settings/custom-attributes/", h.CustomAttributeList)
	secured.HandleFunc("GET /settings/custom-attributes/{id}", h.CustomAttributeEdit)
	secured.HandleFunc("POST /settings/custom-attributes/{id}", h.CustomAttributeSave)
	secured.HandleFunc("DELETE /settings/custom-attributes/{id}", h.CustomAttributeDelete)
