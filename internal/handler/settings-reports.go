...
func (ctrl SettingsCtrl) ListReports(w http.ResponseWriter, r *http.Request) {
	...
	Render(ctrl.store, ctrl.acl, w, r, http.StatusOK, "internal/views/settings-reports-many.html", map[string]any{
...
func (ctrl SettingsCtrl) EditReport(w http.ResponseWriter, r *http.Request) {
	...
	Render(ctrl.store, ctrl.acl, w, r, http.StatusOK, "internal/views/settings-reports-one.html", map[string]any{
		"obj":   obj,
		"valid": valid.Result{},
	})
}
...
func (ctrl SettingsCtrl) SaveReport(w http.ResponseWriter, r *http.Request) {
	...
	if vr := ValidateReport(dto, enums); !vr.Valid() {
		Render(ctrl.store, ctrl.acl, w, r, http.StatusUnprocessableEntity, "internal/views/settings-reports-one.html", map[string]any{
			"obj":   dto,
			"valid": vr,
		})
		return
