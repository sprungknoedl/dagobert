...
func (ctrl SettingsCtrl) ListEnums(w http.ResponseWriter, r *http.Request) {
	...
	Render(ctrl.store, ctrl.acl, w, r, http.StatusOK, "app/views/settings-enums-many.html", map[string]any{
		"title": "Case Objects",
		"enums": enums,
	})
}
...
func (ctrl SettingsCtrl) EditEnum(w http.ResponseWriter, r *http.Request) {
	...
	Render(ctrl.store, ctrl.acl, w, r, http.StatusOK, "app/views/settings-enums-one.html", map[string]any{
		"obj":   obj,
		"valid": valid.Result{},
	})
}
