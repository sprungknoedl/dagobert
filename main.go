...
func main() {
	...
	mux.HandleFunc("GET /cases/{cid}/indicators/import", indicatorCtrl.ImportCSV)
	mux.HandleFunc("POST /cases/{cid}/indicators/import", indicatorCtrl.ImportCSV)
	mux.HandleFunc("POST /cases/{cid}/indicators/timesketch", indicatorCtrl.ImportTimesketch)
