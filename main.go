...
func main() {
	...
	mod.List = append(mod.List, model.Mod{
		Name:        "Hayabusa",
	...
	mod.List = append(mod.List, model.Mod{
		...
		Run:         mod.IngestHayabusa,
	})

	if os.Getenv("TIMESKETCH_URL") != "" && ts != nil {
		mod.List = append(mod.List, model.Mod{
